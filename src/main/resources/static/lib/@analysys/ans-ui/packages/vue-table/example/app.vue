      ...
      <x-table :data="tableData">
        <x-table-column
          ...
          <template slot="content" slot-scope="scope">
            <div style="line-height:30px;text-align: center;background: #eee;">{{scope.content}}-{{scope.$rowIndex}}
            </div>
          </template>
        </x-table-column>
      </x-table>
      ...
      <x-table :data="tableData">
        <x-table-column type="expand">
          <template slot="expand" slot-scope="scope">
            <div style="height: 100px;line-height:100px;text-align:center;color:#cdcdcd;">这里是第{{scope.$index}}行的展开行内容
            </div>
          </template>
        </x-table-column>
        <x-table-column
