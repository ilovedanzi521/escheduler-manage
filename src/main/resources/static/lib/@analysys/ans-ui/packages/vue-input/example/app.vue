<template>
  <div>
    ...
    <section class="demo-section">
      <h4>双向绑定</h4>
      <div>
        <x-input v-model="model" style="width: 200px;"></x-input>
        {{model}}
      </div>
    </section>
    <section class="demo-section">
    ...
    <section class="demo-section">
      ...
      <div>
        ...
        <p>
          <x-input disabled name="disabled" value="disabled" style="width: 200px;"></x-input>
        </p>
        <p>
          <x-input autofocus value="autofocus" style="width: 200px;"></x-input>
        </p>
        <p>
          <x-input autocomplete="on" value="autocomplete" style="width: 200px;"></x-input>
        </p>
        <p>
          <x-input :maxlength="10" value="maxlength" style="width: 200px;"></x-input>
        </p>
        <p>
          <x-input :tabindex="10" value="tabindex" style="width: 200px;"></x-input>
        </p>
      </div>
    </section>
    <section class="demo-section">
    ...
    <section class="demo-section">
      ...
      <div>
        <x-input type="textarea" resize="none" :autosize="{minRows:2,maxRows:4}" value="自适应"
                 style="width: 200px;"></x-input>
      </div>
    </section>
    <section class="demo-section">
      <h4>图标</h4>
