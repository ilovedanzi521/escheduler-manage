...
public interface TaskInstanceMapper {
    ...
    @SelectProvider(type = TaskInstanceMapperProvider.class, method = "queryTaskSubNode")
    List<TaskInstance> queryTaskSubNode(
            @Param("processInstanceIds") Object[] processInstanceIds
    );
    /**
