...
public class AlertDao extends AbstractBaseDao {
    ...
    @Override
    protected void init() {
//        alertMapper = defaultSqlSessionFactory.openSession().getMapper(AlertMapper.class);
//        userAlertGroupMapper = defaultSqlSessionFactory.openSession().getMapper(UserAlertGroupMapper.class);
    }
